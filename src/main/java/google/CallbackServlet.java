...
import google.dao.GooglePlusUser;
...
public class CallbackServlet extends HttpServlet {
    ...
    private static JSONObject getWebContentFromURL_Post(String httpURL, List <NameValuePair>  nvps) {
    	...
    	try { 		
//    		DefaultHttpClient httpclient = new DefaultHttpClient(); //depricated
...
//        	DefaultHttpClient httpclient = new DefaultHttpClient(); //depricated
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            redirectURLbuffer.replace(index, redirectURLbuffer.length(), "").append("/oauth2callback");   //default: .append("/callback")
        	...
        	if(null!=code) {
        		...
        		response.sendRedirect(request.getContextPath() + "/googlePlus/error.html");
        		return;
        	}
            ...
            if(null!=accessToken) {
            	...
            	response.sendRedirect(request.getContextPath() + "/googlePlus/welcome.jsp");
            }
